...
pokeApi.getPokemons = (offset = 151, limit = 10) => {
    const url = `https://pokeapi.co/api/v2/pokemon?offset=${offset}&limit=${limit}` //https://pokeapi.co/api/v2/pokemon/?offset=151&limit=100
